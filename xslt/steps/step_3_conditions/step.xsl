...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:tei="http://www.tei-c.org/ns/1.0" exclude-result-prefixes="xs" version="2.0">
    ...
    <!-- XSLT allows us to run transformations based on conditions
    
    ADD SOMETHING HERE TO SHOW FOR `tei:hi`:
    - WHEN ATTR rend=u -> <u>FOO</u>
    - OTHERWISE -> <sub>FOO</sub>  
    
    ADD SOMETHING HERE TO SHOW FOR `tei:add`:
    - WHEN ATTR place=marginleft -> <span style="left:-5em; position: absolute; font-size: 0.6em;">FOO</span>
    - OTHERWISE -> <s>FOO</s>
    -->
