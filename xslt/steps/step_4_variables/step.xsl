...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:tei="http://www.tei-c.org/ns/1.0" exclude-result-prefixes="xs" version="2.0">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm" style="margin-left: 5em">
                            ...
                            <!-- XSLT variables start with '$'... like PHP :) -->
                            Corrections: <!-- PRINT HERE THER VARIABLE `hand` -->
                        </div>
                    </div>
                </div>
            </body>
    ...
    <!-- ADD SOMETHING HERE TO CREATE A XSLT VARIABLE
         CALLED `named` AND CONTAINING THE COUNT OF ALL
         THE `hand` ATTRIBUTES IN THE DOC
     -->
</xsl:stylesheet>
